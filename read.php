            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $row["prodesc"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Quantity</label>
                        <p class="form-control-static"><?php echo $row["qty"]; ?></p>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $row["pimage"]; ?></p>
                    </div>
                    <p><a href="farmer_product.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>        
        </div>
    </div>
